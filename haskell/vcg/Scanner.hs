...
keywords "invariant" = (INVARIANT, Nothing)
keywords "do" = (DO, Nothing)
keywords "endwhile" = (ENDWHILE, Nothing)
keywords "precondition" = (PRECONDITION, Nothing)
keywords "postcondition" = (POSTCONDITION, Nothing)
keywords "command" = (COMMAND, Nothing)
